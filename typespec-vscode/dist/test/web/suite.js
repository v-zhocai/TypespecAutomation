...
// ../../node_modules/.pnpm/mocha@11.7.0/node_modules/mocha/mocha.js
var require_mocha = __commonJS({
  "../../node_modules/.pnpm/mocha@11.7.0/node_modules/mocha/mocha.js"(exports, module2) {
    (function(global2, factory) {
      ...
      function fromString$1(that, string2, encoding) {
        ...
        var length = byteLength$1(string2, encoding) | 0;
      ...
      function byteLength$1(string2, encoding) {
        if (internalIsBuffer$1(string2)) {
        ...
        for (; ; ) {
          switch (encoding) {
            ...
            default:
              if (loweredCase) return utf8ToBytes$1(string2).length;
      ...
      function hexWrite$1(buf, string2, offset, length) {
      ...
      function utf8Write$1(buf, string2, offset, length) {
        return blitBuffer$1(utf8ToBytes$1(string2, buf.length - offset), buf, offset, length);
      }
      function asciiWrite$1(buf, string2, offset, length) {
        return blitBuffer$1(asciiToBytes$1(string2), buf, offset, length);
      }
      function latin1Write$1(buf, string2, offset, length) {
        return asciiWrite$1(buf, string2, offset, length);
      }
      function base64Write$1(buf, string2, offset, length) {
        return blitBuffer$1(base64ToBytes$1(string2), buf, offset, length);
      }
      function ucs2Write$1(buf, string2, offset, length) {
        return blitBuffer$1(utf16leToBytes$1(string2, buf.length - offset), buf, offset, length);
      }
      Buffer$1.prototype.write = function write2(string2, offset, length, encoding) {
        ...
        for (; ; ) {
          switch (encoding) {
            case "hex":
              return hexWrite$1(this, string2, offset, length);
            case "utf8":
            case "utf-8":
              return utf8Write$1(this, string2, offset, length);
            case "ascii":
              return asciiWrite$1(this, string2, offset, length);
            case "latin1":
            case "binary":
              return latin1Write$1(this, string2, offset, length);
            case "base64":
              return base64Write$1(this, string2, offset, length);
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
              return ucs2Write$1(this, string2, offset, length);
            default:
              if (loweredCase) throw new TypeError("Unknown encoding: " + encoding);
              encoding = ("" + encoding).toLowerCase();
              loweredCase = true;
        ...
        Diff.prototype = {
          ...
          diff: function diff2(oldString, newString) {
            ...
            if (bestPath[0].oldPos + 1 >= oldLen && newPos + 1 >= newLen) {
              return done2(buildValues(self2, bestPath[0].lastComponent, newString, oldString, self2.useLongestToken));
            }
      ...
      var characterDiff = (
        /*istanbul ignore start*/
        character.characterDiff = /*istanbul ignore end*/
      ...
      var wordDiff = (
        /*istanbul ignore start*/
        word.wordDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$5[
          /*istanbul ignore start*/
          "default"
        ...
        if (deletion && insertion) {
          ...
          if (startKeep) {
            var commonWsPrefix = (
              ...
              /*istanbul ignore end*/
              /*istanbul ignore start*/
              (0, _string$1.longestCommonPrefix)(oldWsPrefix, newWsPrefix)
            );
            startKeep.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.replaceSuffix)(startKeep.value, newWsPrefix, commonWsPrefix);
            deletion.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.removePrefix)(deletion.value, commonWsPrefix);
            insertion.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.removePrefix)(insertion.value, commonWsPrefix);
          }
          if (endKeep) {
            var commonWsSuffix = (
              /*istanbul ignore start*/
              /*istanbul ignore end*/
              /*istanbul ignore start*/
              (0, _string$1.longestCommonSuffix)(oldWsSuffix, newWsSuffix)
            );
            endKeep.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.replacePrefix)(endKeep.value, newWsSuffix, commonWsSuffix);
            deletion.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.removeSuffix)(deletion.value, commonWsSuffix);
            insertion.value = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.removeSuffix)(insertion.value, commonWsSuffix);
          }
        } else if (insertion) {
          if (startKeep) {
          ...
          var newWsStart = (
            ...
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.longestCommonPrefix)(newWsFull, delWsStart)
          );
          deletion.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.removePrefix)(deletion.value, newWsStart);
          var newWsEnd = (
            /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.longestCommonSuffix)(
              /*istanbul ignore start*/
              /*istanbul ignore end*/
              /*istanbul ignore start*/
              (0, _string$1.removePrefix)(newWsFull, newWsStart),
              delWsEnd
            )
          );
          deletion.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.removeSuffix)(deletion.value, newWsEnd);
          endKeep.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.replacePrefix)(endKeep.value, newWsFull, newWsEnd);
          startKeep.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.replaceSuffix)(startKeep.value, newWsFull, newWsFull.slice(0, newWsFull.length - newWsEnd.length));
        } else if (endKeep) {
          ...
          var overlap = (
            ...
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.maximumOverlap)(deletionWsSuffix, endKeepWsPrefix)
          );
          deletion.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.removeSuffix)(deletion.value, overlap);
        } else if (startKeep) {
          ...
          var _overlap = (
            ...
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string$1.maximumOverlap)(startKeepWsSuffix, deletionWsPrefix)
          );
          deletion.value = /*istanbul ignore start*/
          /*istanbul ignore end*/
          /*istanbul ignore start*/
          (0, _string$1.removePrefix)(deletion.value, _overlap);
        }
      }
      var wordWithSpaceDiff = (
        /*istanbul ignore start*/
        word.wordWithSpaceDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$5[
          /*istanbul ignore start*/
          "default"
      ...
      var lineDiff = (
        /*istanbul ignore start*/
        line.lineDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$4[
          /*istanbul ignore start*/
          "default"
      ...
      var sentenceDiff = (
        /*istanbul ignore start*/
        sentence.sentenceDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$3[
          /*istanbul ignore start*/
          "default"
      ...
      var cssDiff = (
        /*istanbul ignore start*/
        css.cssDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$2[
          /*istanbul ignore start*/
          "default"
      ...
      var jsonDiff = (
        /*istanbul ignore start*/
        json$1.jsonDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base$1[
          /*istanbul ignore start*/
          "default"
      ...
      jsonDiff.castInput = function(value, options) {
        ...
        ), stringifyReplacer = _options$stringifyRep === void 0 ? function(k, v2) {
          return (
            /*istanbul ignore end*/
      ...
      var arrayDiff = (
        /*istanbul ignore start*/
        array$1.arrayDiff = /*istanbul ignore end*/
        new /*istanbul ignore start*/
        _base[
          /*istanbul ignore start*/
          "default"
          ...
          _objectSpread$2(_objectSpread$2(
            ...
            hunks: patch.hunks.map(function(hunk) {
              return _objectSpread$2(_objectSpread$2(
                ...
                lines: hunk.lines.map(function(line2, i) {
                  var _hunk$lines;
                  return (
                    /*istanbul ignore end*/
                    line2.startsWith("\\") || line2.endsWith("\r") || /*istanbul ignore start*/
                    (_hunk$lines = /*istanbul ignore end*/
                    hunk.lines[i + 1]) !== null && _hunk$lines !== void 0 && /*istanbul ignore start*/
                    _hunk$lines.startsWith("\\") ? line2 : line2 + "\r"
                  );
                })
              });
            })
          ...
          _objectSpread$2(_objectSpread$2(
            ...
            hunks: patch.hunks.map(function(hunk) {
              return _objectSpread$2(_objectSpread$2(
                ...
                lines: hunk.lines.map(function(line2) {
                  return (
                    /*istanbul ignore end*/
                    line2.endsWith("\r") ? line2.substring(0, line2.length - 1) : line2
                  );
                })
              });
            })
        ...
        return !patch.some(function(index) {
          return (
            ...
            index.hunks.some(function(hunk) {
              return (
                /*istanbul ignore end*/
                hunk.lines.some(function(line2) {
                  return (
                    /*istanbul ignore end*/
                    !line2.startsWith("\\") && line2.endsWith("\r")
                  );
                })
              );
            })
        ...
        return patch.some(function(index) {
          ...
          return (
            ...
            index.hunks.every(function(hunk) {
              return (
                /*istanbul ignore end*/
                hunk.lines.every(function(line2, i) {
                  var _hunk$lines2;
                  return (
                    /*istanbul ignore end*/
                    line2.startsWith("\\") || line2.endsWith("\r") || /*istanbul ignore start*/
      ...
      function parsePatch(uniDiff) {
        ...
        function parseIndex() {
          ...
          while (i < diffstr.length) {
            ...
            if (/^(Index:\s|diff\s|\-\-\-\s|\+\+\+\s|===================================================================)/.test(_line2)) {
              break;
            } else if (/^@@/.test(_line2)) {
      ...
      function applyPatch(source, uniDiff) {
        ...
        if (options.autoConvertLineEndings || options.autoConvertLineEndings == null) {
          if (
            ...
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string.hasOnlyWinLineEndings)(source) && /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _lineEndings.isUnix)(uniDiff)
          ) {
            uniDiff = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _lineEndings.unixToWin)(uniDiff);
          } else if (
            /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _string.hasOnlyUnixLineEndings)(source) && /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _lineEndings.isWin)(uniDiff)
          ) {
            uniDiff = /*istanbul ignore start*/
            /*istanbul ignore end*/
            /*istanbul ignore start*/
            (0, _lineEndings.winToUnix)(uniDiff);
          }
        }
        var lines = source.split("\n"), hunks = uniDiff.hunks, compareLine = options.compareLine || function(lineNumber, line3, operation, patchContent) {
          return (
            /*istanbul ignore end*/
            line3 === patchContent
          );
        ...
        for (var i = 0; i < hunks[hunks.length - 1].lines.length; i++) {
          var line2 = hunks[hunks.length - 1].lines[i];
          if (line2[0] == "\\") {
            if (prevLine[0] == "+") {
              removeEOFNL = true;
            } else if (prevLine[0] == "-") {
        ...
        for (var _i = 0; _i < hunks.length; _i++) {
          ...
          for (var _i3 = 0; _i3 < hunkResult.patchedLines.length; _i3++) {
            var _line2 = hunkResult.patchedLines[_i3];
            resultLines.push(_line2);
          }
...
`
      ...
      (function(module3, exports2) {
        ...
        HTML.prototype.testURL = function(test2) {
          return makeUrl("^" + escapeRe(test2.fullTitle()) + "$");
        };
      ...
      (function(module3, exports2) {
        ...
        XUnit.prototype.test = function(test2, options) {
          Base.useColors = false;
          var attrs = {
            classname: test2.parent.fullTitle(),
            name: test2.title,
            file: testFilePath(test2.file, options),
...
// test/web/web.test.ts
var web_test_exports = {};
var vscode;
var init_web_test = __esm({
  "test/web/web.test.ts"() {
    "use strict";
...
async function run() {
  await Promise.resolve().then(() => (init_web_test(), web_test_exports));
